function [t,u,v,r,x,y,psi,U] = Mariner_TurningCircle(mariner,x,ui,t_final,t_rudderexecute,h)
...
grid,axis('auto'),xlabel('x-position'),ylabel('y-position')
